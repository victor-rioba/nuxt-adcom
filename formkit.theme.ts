 ...
 *
 * @checksum - b89ea0f8cbb59676c686dbf72e181efa13ff0f1fe5f1e4730764464c8a5a6a55
 * @variables - radius=rounded-lg,accentColor=cyan,colorTemperature=zinc,spacing=2,scale=sm,inputShadow=shadow-sm,baseColorShade=500,borderShadeLightMode=300,borderShadeDarkMode=400,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
 * @theme - regenesis
 **/
