 ...
 *
 * @checksum - 7c610314bf38c47929930bb5932eb5a0502f021319750cd2ce43696a406fb837
 * @variables - radius=rounded-lg,accentColor=cyan,colorTemperature=zinc,spacing=2,scale=sm,inputShadow=shadow-sm,baseColorShade=500,borderShadeLightMode=300,borderShadeDarkMode=400,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
 * @theme - regenesis
 **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:box__decorator": {
    ...
    "bg-white": true,
    "ring-cyan-400": true,
    "peer-checked:border-cyan-500": true,
    relative: true,
    block: true,
    "text-base": true,
    "w-[1em]": true,
    ...
    "peer-checked:bg-cyan-50": true,
    "peer-checked:text-cyan-500": true,
    ...
    "dark:ring-offset-cyan-400": true,
    "dark:peer-focus-visible:ring-1": true,
    "dark:peer-disabled:bg-zinc-600/50": true,
    "dark:peer-checked:bg-cyan-800": true,
    "dark:peer-checked:text-cyan-300": true,
  },
  ...
  "family:text__inner": {
    ...
    "focus-within:!ring-cyan-400": true,
    "focus-within:!border-cyan-400": true,
  ...
  "family:dropdown__listbox": {
    ...
    "group-data-[overscroll]:dark:border-zinc-500": true,
  },
  "family:dropdown__listitem": {
    ...
    "text-zinc-700": true,
    "text-sm": true,
    "data-[is-active]:bg-cyan-100": true,
    ...
    "data-[is-active]:before:ring-cyan-400": true,
    "data-[is-active]:before:ring-inset": true,
    "data-[is-active]:before:ring-offset-cyan-100": true,
  },
  ...
  "family:dropdown__tagWrapper": {
    ...
    "data-[active-selection=true]:ring-cyan-400": true,
  },
  ...
  "family:dropdown__tag": {
    ...
    "group-data-[active-selection=true]/tag:bg-cyan-300": true,
  ...
  "family:dropdown__emptyMessage": {
    ...
    "aria-selected:bg-cyan-500": true,
  },
  button__input: {
    "appearance-none": true,
    "[color-scheme:light]": true,
    ...
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "bg-cyan-50": true,
    "hover:bg-cyan-100": true,
    "dark:text-cyan-500": true,
    "dark:bg-transparent": true,
    "dark:hover:bg-cyan-50/5": true,
  },
  checkbox__decorator: {
    rounded: true,
  },
  ...
  date__input: {
    ...
    "selection:text-zinc-700": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "focus:[&::-webkit-datetime-edit-day-field]:bg-cyan-100": true,
    "focus:[&::-webkit-datetime-edit-month-field]:bg-cyan-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-cyan-100": true,
  },
  "datetime-local__input": {
    ...
    "focus:[&::-webkit-datetime-edit-month-field]:bg-cyan-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-cyan-100": true,
    "focus:[&::-webkit-datetime-edit-hour-field]:bg-cyan-100": true,
    "focus:[&::-webkit-datetime-edit-minute-field]:bg-cyan-100": true,
    "focus:[&::-webkit-datetime-edit-ampm-field]:bg-cyan-100": true,
  },
  file__fileList: {
    "group/list": true,
    peer: true,
  ...
  file__fileRemove: {
    ...
    "peer-data-[has-multiple]:text-cyan-500": true,
  ...
  form__messageLink: {
    ...
    "group-[]/summary:ring-cyan-500": true,
  },
  month__input: {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  range__input: {
    ...
    "[&::-webkit-slider-thumb]:bg-cyan-500": true,
    ...
    "[&::-webkit-slider-thumb]:focus:!ring-cyan-400": true,
    ...
    "[&::-moz-range-thumb]:bg-cyan-500": true,
    ...
    "[&::-moz-range-thumb]:focus:!ring-cyan-400": true,
  ...
  select__option: {
    ...
    "group-data-[multiple]:checked:bg-cyan-100": true,
    "group-data-[multiple]:focus:bg-cyan-100": true,
    ...
    "dark:group-data-[multiple]:focus:bg-cyan-700": true,
    "dark:group-data-[multiple]:checked:bg-cyan-700": true,
  },
  select__prefixIcon: {
    flex: true,
    "items-center": true,
  ...
  submit__input: {
    ...
    "bg-cyan-500": true,
    "!text-white": true,
    "active:text-cyan-100": true,
    "active:bg-cyan-600": true,
  ...
  week__input: {
    ...
    "selection:text-zinc-700": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "focus:[&::-webkit-datetime-edit-week-field]:bg-cyan-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-cyan-100": true,
  },
  ...
  colorpicker__control: {
    ...
    "focus-visible:ring-cyan-400": true,
  },
  ...
  colorpicker__fieldGroup: {
    ...
    "[&>input]:selection:bg-cyan-100": true,
    "[&>input]:m-0": true,
    "[&>input]:grow": true,
    "[&>input]:shrink": true,
    "[&>input]:w-full": true,
    ...
    "[&>input:focus]:border-cyan-500": true,
  ...
  colorpicker__swatch: {
    ...
    "[&>canvas:focus-visible]:ring-cyan-400": true,
  ...
  datepicker__dayCell: {
    ...
    "dark:bg-zinc-600": true,
    "dark:text-zinc-300": true,
    "dark:aria-selected:bg-cyan-500": true,
    "dark:aria-selected:text-white": true,
    "dark:focus:outline-cyan-500": true,
  ...
  datepicker__timeInput: {
    ...
    "p-1.5": true,
    "my-2.5": true,
    "focus-visible:outline-cyan-500": true,
    "dark:text-zinc-300": true,
    "dark:bg-transparent": true,
    "dark:border-zinc-500": true,
  },
  ...
  datepicker__dayButton: {
    ...
    "dark:text-zinc-300": true,
    "dark:border-zinc-500": true,
    "dark:hover:border-cyan-400": true,
  },
  ...
  datepicker__calendarIcon: {
    "text-zinc-600": true,
    "focus-visible:text-cyan-500": true,
    flex: true,
    "w-[1em]": true,
    "grow-0": true,
    "shrink-0": true,
  ...
  slider__minValue: {
    ...
    "dark:[&>div>div::after]:bg-zinc-400": true,
  },
  slider__maxValue: {
    grow: true,
    "!max-w-[45%]": true,
  ...
  toggle__track: {
    ...
    "shadow-none": true,
    "peer-focus-visible:ring-2": true,
    "peer-focus-visible:ring-cyan-400": true,
  ...
  togglebuttons__input: {
    ...
    "dark:disabled:text-cyan-500": true,
    "dark:text-cyan-500": true,
    "aria-[pressed=true]:bg-cyan-500": true,
    "aria-[pressed=true]:text-white": true,
    "dark:aria-[pressed=true]:bg-cyan-500": true,
    ...
    "group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-cyan-500":
      true,
    "group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-cyan-500":
      true,
    "group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-cyan-500":
      true,
    "dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-cyan-500":
      true,
    "dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-cyan-500":
      true,
    "dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-cyan-500":
      true,
    ...
    "group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-cyan-500":
      true,
    "group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-cyan-500":
      true,
    "group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-cyan-500":
      true,
    "dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-cyan-500":
      true,
    "dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-cyan-500":
      true,
    "dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-cyan-500":
      true,
  },
  transferlist__outer: {
    group: true,
    ...
    "text-sm": true,
    "max-w-none": true,
    "[&_.dnd-placeholder]:bg-cyan-500": true,
  ...
  transferlist__transferlist: {
    ...
    "[&:has(:focus-visible)]:ring-cyan-400": true,
    "dark:border-zinc-500": true,
  ...
  transferlist__transferlistListItem: {
    ...
    "ring-1": true,
    "ring-zinc-200": true,
    "aria-selected:bg-cyan-100": true,
    "data-[is-active=true]:bg-cyan-100": true,
    "data-[is-active=true]:ring-cyan-200": true,
    "aria-selected:ring-cyan-200": true,
    relative: true,
    flex: true,
    "cursor-pointer": true,
    "items-center": true,
    ...
    "dark:bg-zinc-800": true,
    "dark:text-zinc-300": true,
    "dark:data-[is-active=true]:bg-cyan-800": true,
    "dark:aria-selected:bg-cyan-800": true,
    "dark:ring-zinc-600": true,
    "dark:data-[is-active=true]:ring-cyan-600": true,
    "dark:aria-selected:ring-cyan-600": true,
    "[&.formkit-dropZone]:bg-cyan-100": true,
    "[&.formkit-selectionDropZone]:bg-cyan-100": true,
    "[&.formkit-touchDropZone]:bg-cyan-100": true,
    "[&.formkit-touchSelectionDropZone]:bg-cyan-100": true,
    "[&.formkit-longTouch]:bg-cyan-100": true,
    "dark:[&.formkit-dropZone]:bg-cyan-900": true,
    "dark:[&.formkit-selectionDropZone]:bg-cyan-900": true,
    "dark:[&.formkit-touchDropZone]:bg-cyan-900": true,
    "dark:[&.formkit-touchSelectionDropZone]:bg-cyan-900": true,
    "dark:[&.formkit-longTouch]:bg-cyan-900": true,
  },
  ...
  transferlist__transferlistSearch: {
    ...
    "dark:border-zinc-500": true,
    "dark:text-zinc-300": true,
    "dark:selection:bg-cyan-100": true,
    "dark:selection:text-zinc-700": true,
    "dark:bg-zinc-800": true,
  },
  ...
  "multi-step__tabs": {
    ...
    'dark:group-data-[tab-style="tab"]/wrapper:border-zinc-500': true,
  ...
  "multi-step__tab": {
    ...
    'dark:group-data-[tab-style="progress"]/wrapper:before:border-zinc-500':
      true,
    ...
    'group-data-[tab-style="progress"]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-cyan-500':
      true,
    'group-data-[tab-style="progress"]/wrapper:last:after:hidden': true,
    'dark:group-data-[tab-style="progress"]/wrapper:after:bg-zinc-500': true,
    'dark:group-data-[tab-style="progress"]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-cyan-500':
      true,
  },
  ...
  "multi-step__badge": {
    ...
    "text-white": true,
    "rounded-full": true,
    "group-data-[valid=true]/tab:bg-cyan-500": true,
